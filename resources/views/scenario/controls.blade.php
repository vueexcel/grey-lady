	...
	<table id="scenario-control">
		<form id="scenario-control-form">
			...
			<tr>
				...
				<td><input type="range" name="purchase_price" min="{{ $listing->details->price * 0.5 }}" max="{{ $listing->details->price * 1.5 }}" value="{{ $listing->details->price }}" step="10000"></td>
				<td><span class="scenario-value" id="purchase_price"></span></td>
				<td><span>{{ formatLargeCurrency($listing->details->price) }}</span></td>
			</tr>
			<tr>
				<td>Rennovation Costs</td>
				<td><input type="range" name="rennovation_costs" min="0" max="500000" step="10000" value="0"></td>
				<td><span class="scenario-value" id="rennovation_costs"></span></td>
				<td><span>$0</span></td>
			</tr>
			<tr>
				<td>Finance Renovation Costs</td>
				<td><input type="checkbox" name="finance_renovation_costs"></td>
				<td><span class="scenario-value" id="finance_renovation_costs"></span></td>
				<td><span>No</span></td>
			</tr>
			<tr>
				<td>Rent</td>
				<td><input type="range" name="monthly_rent" min="{{ $listing->calculated_fields[0]->operating_profit_and_loss->monthly->revenue * 0.5 }}" max="{{ $listing->calculated_fields[0]->operating_profit_and_loss->monthly->revenue * 1.5 }}" value="{{ $listing->calculated_fields[0]->operating_profit_and_loss->monthly->revenue }}" step="100"></td>
			...
			<tr>
				<td>Downpayment Percentage</td>
				<td><input type="range" name="downpayment_percentage" min="0" max="1" value="{{ $listing->calculated_fields[0]->settings_used->downpayment }}" step="0.01"></td>
			...
			<tr>
				<td>Opex_percentage</td>
				<td><input type="range" name="Opex_percentage" min="0" max="1" value="{{ $listing->calculated_fields[0]->settings_used->operational_expenses }}" step="0.01"></td>
			...
			<tr>
				<td>Interest Rate</td>
				<td><input type="range" name="interest_rate" min="0" max="0.3" value="0.06" step="0.01"></td>
